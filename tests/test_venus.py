...
def test_plot(request, product_l1):
    ...
    generic.plot(request, l1, 'B4', poi = {"x": 5000, "y": 5000})
    
def test_flag_reader(product_l1):
    l1 = Level1_VENUS(product_l1, read_masks=True)
    generic.Test.flagreader(l1)